...
function showAlready() {
  document.getElementById("survey-body").innerHTML =
    `<div class="card" style="margin:18px auto;max-width:520px;text-align:center">
      ...
      <p>This device has already completed the Firefighter I survey. Each member should submit once — thank you for your response.</p>
      <a href="results.html" class="btn btn-teal" style="display:inline-block;margin-top:8px">View live results →</a>
